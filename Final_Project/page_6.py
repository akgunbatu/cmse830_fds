...
cat_cols = ["make", "fuel_type", "Transmission Class"]

# One-hot encode dataset (this builds the template for encoding user input)
...
X = df_encoded.drop(columns=['price','drivetrain','body_type', 'transmission','model'])
y = df_encoded["price"]
